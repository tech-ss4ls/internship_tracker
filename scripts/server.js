...
const JWT_SECRET = 'SECRET KEY GOES HERE';
...
app.post('/api/signup', async(req,res)=>{
    ...
    try{
        ...
        const token = jwt.sign({userId: newUser.user_id}, JWT_SECRET, {expires_in:'7d' });
...
app.post('/api/login', async(req, res)=> {
    ...
    try{
        ...
        // Get JWT 
        const token = jwt.sign({userId: user.user_id}, JWT_SECRET, {expires_in:'7d' });
